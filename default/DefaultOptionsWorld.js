...
//OpenLayers.ProxyHost = "cgi-bin/heron.cgi?url=";
...
//	May use new NASA WMTS : http://onearth.jpl.nasa.gov/wms.cgi?request=GetCapabilities
    ...
    new OpenLayers.Layer.WMS(
            "Vietnam provinces",
            'http://dev.dothanhlong.org:8080/geoserver/dothanhlong/wms?',
            {layers: "dothanhlong:vn_provinces", transparent: true, format: 'image/png'},
